...
const Hero: React.FC = () => {
  ...
  // Efecto para manejar la clase 'dark' y el localStorage
  useEffect(() => {
  ...
  // Recuperar el estado del modo oscuro del localStorage cuando se cargue la página
  useEffect(() => {
  ...
  return (
    <div className="relative bg-blue-500 dark:bg-gray-900 overflow-hidden">
        ...
        <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div className="sm:text-center lg:text-left">
            <h2 className="text-4xl tracking-tight font-extrabold text-white dark:text-gray-200 sm:text-5xl md:text-6xl">
              ...
              <span className="block text-gray-900 dark:text-gray-300">tranquilidad</span>
            </h2>
            ...
            <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              <div className="rounded-md shadow">
                <Link
                  to="/contact"
                  className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-red-600 bg-white hover:bg-gray-50 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 md:py-4 md:text-lg md:px-10"
                >
                  Contáctenos
                </Link>
              </div>
